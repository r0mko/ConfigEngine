...
void JsonConfig::setProperty(const QString &layer, const QString &key, const QVariant &value)
{
    int propIdx = -1;
...
void JsonConfig::updateLayerPath(const QString &layer, const QString &filePath)
{
